...
def test_identity_lemmatizer():
    nlp = stanfordnlp.Pipeline(**{'processors': 'tokenize,lemma', 'models_dir': TEST_WORKING_DIR, 'lang': 'en',
...
def test_full_lemmatizer():
    nlp = stanfordnlp.Pipeline(**{'processors': 'tokenize,pos,lemma', 'models_dir': TEST_WORKING_DIR, 'lang': 'en'})
    doc = nlp(EN_DOC)
