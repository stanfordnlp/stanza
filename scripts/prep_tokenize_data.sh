...
if [ $lang == "vi" ]; then
    python utils/postprocess_vietnamese_tokenizer_data.py $UDBASE/$treebank/${short}-ud-${set}.txt data/tokenize/${short}-ud-${set}.toklabels -o data/tokenize/${short}-ud-${set}.json
fi
