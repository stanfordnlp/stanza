...
if [ $tag_type == 'gold' ]; then
    ...
    train_cmd='python -m stanfordnlp.models.tagger --eval_file '${gold_train_file}' --gold_file '${gold_train_file}' --output_file '${train_in_file}' --lang '${original_short}' --shorthand '${original_short}' --batch_size '${batch_size}' --mode predict'
    echo ''
    echo $train_cmd
    echo ''
    eval $train_cmd
    ...
    dev_cmd='python -m stanfordnlp.models.tagger --eval_file '${gold_dev_file}' --gold_file '${gold_dev_file}' --output_file '${dev_in_file}' --lang '${original_short}' --shorthand '${original_short}' --batch_size '${batch_size}' --mode predict'
    echo ''
    echo $dev_cmd
    eval $dev_cmd
