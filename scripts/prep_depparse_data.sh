...
if [ $tag_type == 'gold' ]; then
    ...
    train_cmd='python -m stanfordnlp.models.tagger --eval_file '${gold_train_file}' --gold_file '${gold_train_file}' --output_file '${train_in_file}' --lang '${src_short}' --shorthand '${src_short}' --mode predict --save_dir saved_models/pos'
    echo ''
    echo $train_cmd
    echo ''
    eval $train_cmd
    ...
    dev_cmd='python -m stanfordnlp.models.tagger --eval_file '${gold_dev_file}' --gold_file '${gold_dev_file}' --output_file '${dev_in_file}' --lang '${src_short}' --shorthand '${src_short}' --mode predict --save_dir saved_models/pos'
    echo ''
    echo $dev_cmd
    eval $dev_cmd
