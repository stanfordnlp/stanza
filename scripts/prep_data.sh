...
python utils/prepare_tokenizer_data.py $UDBASE/$treebank/${short}-ud-${set}.txt $UDBASE/$treebank/${short}-ud-${set}.conllu -o data/${short}-ud-${set}.toklabels -m data/${short}-ud-${set}-mwt.json
if [ $lang == "vi" ]; then
