...
$PYTHON main.py --save_dir $SAVE_DIR/$fullname/Tagger --save_metadir $SAVE_DIR run $inputfile --CoNLLUDataset batch_size=1000 --SubtokenVocab max_buckets=3 | $PYTHON ${ROOT0}/utils/post_insert_mwt.py $inputfile $outputfile
