...
python -m stanza.models.ner_tagger --wordvec_pretrain_file $WORDVEC_DIR --dropout 0.6 --word_dropout 0.1 --locked_dropout 0.1 --char_dropout 0.1 --train_file $train_file --eval_file $dev_file \
    --lang $lang --shorthand $short --mode train $args
python -m stanza.models.ner_tagger --wordvec_pretrain_file $WORDVEC_DIR --eval_file $dev_file \
    --lang $lang --shorthand $short --mode predict $args
python -m stanza.models.ner_tagger --wordvec_pretrain_file $WORDVEC_DIR --eval_file $test_file \
    --lang $lang --shorthand $short --mode predict $args
