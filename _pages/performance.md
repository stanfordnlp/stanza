...
Performance as of v1.0 on UD 2.5 [is also available](v100performance.md).  All models are trained and tested with the Universal Dependencies v2.5 treebanks.
