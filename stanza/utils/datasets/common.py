...
def build_argparse():
    ...
    parser.add_argument('--english_additional', action='store_true', default=False, help="Include ParTUT and LinES as additional tag columns when building en_combined.  See models/pos/extra_tag_columns.md for an explanation of these results - they don't help anything")
