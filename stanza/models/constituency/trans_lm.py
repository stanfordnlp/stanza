...
def batchify(device, data: Tensor, bsz: int) -> Tensor:
...
def main():
    ...
    batch_size = 20
    eval_batch_size = 10
    train_data = batchify(device, train_data, batch_size)  # shape [seq_len, batch_size]
    val_data = batchify(device, val_data, eval_batch_size)
    test_data = batchify(device, test_data, eval_batch_size)
